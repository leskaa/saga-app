    ...
    return (
        <React.Fragment>
            <Row style={{height: '10%'}}>
                <Col span = {18}/>
                <Col span = {3}>
                    <Button type="primary" style={{width: "100%"}} onClick={() => setIsModalVisible(true)}> Invite Adventurer </Button>
                </Col>
                <Col span = {3}/>
            </Row>
            <Row style={{height: '10%'}}/>
            ...
            { isModalVisible && (
            <InviteStudentModal user={user} visible={isModalVisible} onOk={() => setIsModalVisible(false)} onCancel={() => setIsModalVisible(false)}/>
            )}
        </React.Fragment>
    );
};
